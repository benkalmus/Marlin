...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  10, 100 }, { X_BED_SIZE-10,  100 } }
  /**
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 40*60, 40*60, 2*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  // Add Probe Z Offset calibration to the Z Probe Offsets menu
    ...
    #define PROBE_OFFSET_WIZARD
      ...
      //
      #define PROBE_OFFSET_WIZARD_START_Z -11.90
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.25//0.42    // Unit: mm compression per 1mm/s extruder speed
