...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  HOTEND_Kp //22.20
    #define DEFAULT_Ki  HOTEND_Ki //1.08
    #define DEFAULT_Kd  HOTEND_Kd //114.00
  #endif
#endif // PIDTEMP
...
#define SERVO_DEPLOY    165
#define SERVO_STOW      110
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { SENSOR_X_OFFSET, SENSOR_Y_OFFSET, SENSOR_Z_OFFSET }
